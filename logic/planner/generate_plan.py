...
initial = 'Инцидент(Камера_сломана, ул_Каширское_шоссе) & Свободна(Парковочные_службы_1) & ' \
          ...
          'Инцидент(ТО_кибератака, ул_Толстого) & Свободна(Системный_администратор_1) &' \
          'Инцидент(Человек_без_сознания, ул_Пушкина) & Свободна(Экстренные_службы_2) &' \
...
goals = 'Вызвана_служба(Парковочные_службы_1, ул_Каширское_шоссе, Камера_сломана) & ' \
        ...
        'Вызваны_IT_специалисты(Системный_администратор_1, ул_Толстого, ТО_кибератака) &' \
        'Вызвана_служба(Экстренные_службы_2, ул_Пушкина, Человек_без_сознания) &' \
...
domain = 'ТипИнцидента(Камера_сломана) & Служба(Парковочные_службы_1) & Локация(ул_Каширское_шоссе) &' \
         ...
         'ТипИнцидента(ТО_кибератака) & Служба(Системный_администратор_1) & Локация(ул_Толстого) &' \
         'ТипИнцидента(Человек_без_сознания) & Служба(Экстренные_службы_2) & Локация(ул_Пушкина) &' \
