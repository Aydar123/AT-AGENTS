...
initial='Инцидент(Стоит_на_газоне, Каширское_шоссе) & Инцидент(Не_проходит_оплата, Окская_ул) & Инцидент(Аварийная_ситуация, Каширское_шоссе) & Инцидент(Уборка, Окская_ул) & Инцидент(Ремонт, Каширское_шоссе) & Свободна(Парковочные_службы_1) & Свободна(Городские_службы_1) & Свободна(Парковочные_службы_2) & Свободна(С4) & Автомобиль(Транспортное_средство_1) & Автомобиль(Транспортное_средство_2) & ПарковкаДоступна(Окская_ул) & ПарковкаДоступна(Каширское_шоссе)'
goals='Вызвана_служба(Парковочные_службы_2, Каширское_шоссе, Аварийная_ситуация) & МашинаНаПарковке(Транспортное_средство_1, Парковка_1, Окская_ул) & МашинаНаПарковке(Транспортное_средство_2, Парковка_2, Каширское_шоссе)'
domain='ТипИнцидента(Стоит_на_газоне) & ТипИнцидента(Аварийная_ситуация) & ТипИнцидента(Не_проходит_оплата) & ТипИнцидента(Уборка) & ТипИнцидента(Ремонт) & Локация(Окская_ул) & Локация(Каширское_шоссе) & Автомобиль(Транспортное_средство_1) & Автомобиль(Транспортное_средство_2) & Парковка(Парковка_1) & Парковка(Парковка_2) & Служба(Парковочные_службы_1) & Служба(Городские_службы_1) & Служба(Парковочные_службы_2) & Служба(С4)'

goal_mapping_dict = {
    'Вызвать_парковочные_службы_для_уборки': 'Вызвана_служба(Парковочные_службы_2, Каширское_шоссе, Аварийная_ситуация)',
    ...
    'Вызвать_парковочные_службы_из_за_неправильной_парковки': 'Вызвана_служба(Парковочные_службы_2, Каширское_шоссе, Аварийная_ситуация)',
    'Вызвать_городские_службы': 'Вызвана_служба(Парковочные_службы_2, Каширское_шоссе, Аварийная_ситуация)',
    'Отправить_предупреждение': 'МашинаНаПарковке(Транспортное_средство_2, Парковка_2, Каширское_шоссе)'
}

########################### Исходные данные для 1 эксперимента - БЕЗОПАСНОСТЬ ###########################
# initial = 'Инцидент(Камера_сломана, ул_Каширское_шоссе) & Свободна(Парковочные_службы_1) & ' \
#           'Инцидент(Драка, ул_Окская) & Свободна(Экстренные_службы_1) &' \
#           'Инцидент(Шлагбаум_не_реагирует_на_сигнал, ул_Москворечье)'
#
# goals = 'Вызвана_служба(Парковочные_службы_1, ул_Каширское_шоссе, Камера_сломана) & ' \
#         'Вызвана_служба(Экстренные_службы_1, ул_Окская, Драка) &' \
#         'Перезагрузить_систему(ПО_1, ул_Москворечье, Шлагбаум_не_реагирует_на_сигнал)'
#
# domain = 'ТипИнцидента(Камера_сломана) & Служба(Парковочные_службы_1) & Локация(ул_Каширское_шоссе) &' \
#          'ТипИнцидента(Драка) & Служба(Экстренные_службы_1) & Локация(ул_Окская) &' \
#          'ТипИнцидента(Шлагбаум_не_реагирует_на_сигнал) & Программное_обеспеч(ПО_1) & Локация(ул_Москворечье)'
#
# goal_mapping_dict = {
#     "Вызвать_парковочные_службы_для_устранения_неисправностей": "Вызвана_служба(Парковочные_службы_1, ул_Каширское_шоссе, Камера_сломана)",
#     "Вызвать_полицию": "Вызвана_служба(Экстренные_службы_1, ул_Окская, Драка)",
#     "Вызвать_сисадминов": "Вызваны_IT_специалисты(Системный_администратор_1, ул_Толстого, ТО_кибератака)",
#     "Вызвать_экстренные_службы": "Вызвана_служба(Экстренные_службы_2, ул_Пушкина, Человек_без_сознания)",
#     "Перезагрузить_систему": "Перезагрузить_систему(ПО_1, ул_Москворечье, Шлагбаум_не_реагирует_на_сигнал)"
# }
########################### Исходные данные для 1 эксперимента - БЕЗОПАСНОСТЬ ###########################
